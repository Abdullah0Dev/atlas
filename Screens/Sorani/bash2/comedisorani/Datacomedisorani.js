...
import { StyleSheet, Text,Button, ActivityIndicator,View,Image, ScrollView,Platform, TouchableOpacity,TextInput,Linking,StatusBar} from 'react-native';
...
export default function Datacomedisorani({ navigation,route,klil, }) {
