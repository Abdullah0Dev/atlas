...
import { StyleSheet, Alert,ActivityIndicator ,Modal,Pressable,Text,Button, View,Image, ScrollView,Platform, TouchableOpacity,TextInput,Linking,StatusBar} from 'react-native';
...
export default function Datadramabadini({ navigation,route,klil, }) {
