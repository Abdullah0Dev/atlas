...
import { StyleSheet, Text,Button, View,ActivityIndicator,Image, ScrollView,Platform, TouchableOpacity,TextInput,Linking,StatusBar} from 'react-native';
...
export default function Datacomedibadini({ navigation,route,klil, }) {
